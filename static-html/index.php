                ...
                <article class="hero__slide swiper-slide">
                    ...
                    <div class="hero__entry-text">
                        <div class="hero__entry-text-inner">
                            ...
                            <a class="hero__more-link" href="single.php">Read More</a>
                        </div>
                    </div>
                </article>
                <article class="hero__slide swiper-slide">
            ...
            <div class="bricks-wrapper" data-animate-block>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__thumb">
                        <a href="single.php" class="thumb-link">
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Just a Normal Simple Blog
                                    Post.</a></h1>
                        </div>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Throwback To The Good Old
                                    Days.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">5 Grayscale Coloring
                                    Techniques.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">What Minimalism Really Looks
                                    Like.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">10 Interesting Facts About
                                    Caffeine.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Red and Blue Photo
                                    Effects.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">10 Practical Ways to Be
                                    Minimalist.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">What Does Reading Do to Your
                                    Brain?</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Symmetry In Modern
                                    Design.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">10 Tips for Managing Time
                                    Effectively.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
                ...
                <article class="brick entry" data-animate-el>
                    ...
                    <div class="entry__text">
                        <div class="entry__header">
                            ...
                            <h1 class="entry__title"><a href="single.php">Black And White Photography
                                    Tips.</a></h1>
                        </div>
                        <div class="entry__excerpt">
                            <p>
